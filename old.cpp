...
//      for (std::vector<int>::iterator it = client_read.begin(); it != client_read.end(); it++) {
//        close(*it);
//      }
//      exit(EXIT_FAILURE);
//    }
...
//    }
//    else {
//      for (std::vector<int>::iterator it = client_read.begin(); it != client_read.end() && select_value > 0; it++) {
...
//            }
//            max_fd = *std::max_element(client_read.begin(), client_read.end());
